...
Bookself is open-source, Git-native publishing software for books, papers, course texts, and other long-form work. Manuscripts are plain Markdown. Git provides history and review. A private Desk holds work in progress; a public Shelf holds intentionally released snapshots. The Reader and Publishing Desk are shared static software.
...
- A real Desk is private by default. A Shelf is public. Do not weaken that boundary or expose private Desk content.
...
It is an intentionally public Desk-style teaching specimen, not a real private Desk. Read its working proof, `REVIEW.md`, and the linked public review thread before proposing a change. The goal is to shorten the innermost loop:
