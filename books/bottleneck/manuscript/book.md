...
## The Innermost Loop of Powering Intelligent Machines

### Sven Hard Benson

*An original book about the bottlenecks governing GPUs, memory, custom silicon, foundries, packaging, power, geopolitics, and the strange economics of the AI infrastructure race.*
...
## Chapter 51 — The Bottleneck Behind the Bottleneck

We began with bottlenecks.

The transistor bottleneck led to architectural innovation. The memory bottleneck led to HBM. Reticle and yield constraints led to chiplets and advanced packaging. Packaging constraints led to new interconnects. Cluster constraints led to networking. Data-center constraints led to power and cooling. Geopolitical constraints led to industrial policy and duplicated supply chains.

What is the bottleneck behind all of them?
...
The semiconductor war is not a war to remove constraints forever.

There is no final constraint.

It is a war over who gets to own, solve, or route around the next bottleneck first.
...
The winners of the semiconductor wars will possess extraordinary power. The wisest among them will understand that power is temporary, bottlenecks move, ecosystems remember, and every constraint removed becomes the starting condition for the next one.

Inside the machine, the loop begins again.
